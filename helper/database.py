...
class Database:
    ...
    def new_user(self, id):
        return dict(
            ...
            suffix=None,
            metadata_mode=False,
            metadata_code=""" -map 0 -c:s copy -c:a copy -c:v copy -metadata title="Powered By:- @@WarriorUnitsBots" -metadata author="@oo7jatji" -metadata:s:s title="Subtitled By :- @WarriorUnitsBots" -metadata:s:a title="By :- @WarriorUnitsBots" -metadata:s:v title="By:- @WarriorUnitsBots" """,
            expiry_time=None,
